...
- 报告质量复核：上传 `.xlsx`类型文件，系统会读取首个工作表中的“情况说明”列，并提取“疑点信息”“人工判断”等字段作为复核参考和结果对照。
...
- 仅支持 `.xlsx`。
- 读取首个工作表。
- 报告正文列名必须为“情况说明”，匹配时忽略首尾空格。
- 如文件包含“疑点信息”“人工判断”“申报更正情况”，系统会在解析后展示，并在复核时作为风险简述、人工判断和更正情况参考。
- “人工判断”字段取值应为“有问题”或“无问题”。
